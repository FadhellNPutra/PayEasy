...
const(
	...
	SelectAllMerchants = "SELECT id, name_merchants, id_users, balance, created_at, updated_at FROM merchant LIMIT $1 OFFSET $2"
	SelectMerchantsById = "SELECT id, name_merchants, id_users, balance, created_at, updated_at FROM merchants WHERE id = $1"
